...
public interface StudentDAO {
	 ...
	 */
	Student getObject(Connection conn, int studentId) throws NotFoundException, SQLException;
	 ...
	 */
	void load(Connection conn, Student valueObject) throws NotFoundException, SQLException;
	 ...
	 */
	void create(Connection conn, Student valueObject) throws SQLException;
	 ...
	 *            Primary-key field must be set for this to work properly.
	 */
	void save(Connection conn, Student valueObject) throws NotFoundException, SQLException;
	 ...
	 *            Primary-key field must be set for this to work properly.
	 */
	void delete(Connection conn, Student valueObject) throws NotFoundException, SQLException;
	 ...
	 *            This method requires working database connection.
	 * @param valueObject
	 *            This parameter contains the class instance where search will be
	 *            based. Primary-key field should not be set.
	 */
	List searchMatching(Connection conn, Student valueObject) throws SQLException;
